...
async function main() {
  ...
  const contractFactory = await hre.ethers.getContractFactory("PrivateNFTTest");
  ...
  console.log(
    `Minting Transaction hash: https://explorer-evm.testnet.swisstronik.com/tx/${safeMintTx.hash}`
  );
}
